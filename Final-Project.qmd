...
#necessary in RMarkdown but not in a Qmd or in some instalations of R
#library(reticulate) #how to use Python in RMarkdown
...
# Import Pandas
import numpy as np   # remember pandas runs on top of numpy
import pandas as pd  
...
states = pd.DataFrame({'population': pop,'area': area}) # save into DataFrame object
print(states)  #entire data
print(states.index)  # dataframe index

print(states.columns) #columns of the dataframe
